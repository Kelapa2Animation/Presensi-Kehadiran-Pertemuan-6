...
function setup() {
  ...
  judul.style('color', '#FFFFFF'); // Mengubah warna font judul menjadi putih
  judul.style('font-size', '24px'); // Mengatur ukuran font judul
  nama = createElement('h2', 'Denny Fadilah Umar_122160081');
  nama.position(30, 50);
  nama.style('color', '#FFFFFF'); // Mengubah warna font nama menjadi putih
...
function draw() {
  background(50, 50, 50); // Membersihkan area gambar kanvas dengan warna latar belakang
